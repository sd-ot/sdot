...
int main( int argc, char **argv ) {
    ...
    PMPI_0( mpi->reduction( Time::delta( t0, t1 ), [](double a, double b ) { return a + b; } ) );
    PMPI_0( mpi->reduction( Time::delta( t1, t2 ), [](double a, double b ) { return a + b; } ) );
    PMPI_0( mpi->reduction( Time::delta( t0, t2 ), [](double a, double b ) { return a + b; } ) );
