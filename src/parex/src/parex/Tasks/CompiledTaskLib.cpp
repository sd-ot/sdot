...
CompiledTaskLib::CompiledTaskLib( const Path &src_path, const std::vector<Type *> &children_types ) : GeneratedLib( "compiled_task_kernels", summary( src_path, children_types ) ) {
}

void CompiledTaskLib::make_srcs( SrcWriter &sw ) {
