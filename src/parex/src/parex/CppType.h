...
public:
    ...
    /**/                                CppType                   ( std::string name, std::vector<std::string> include_directories = {}, std::vector<std::string> includes = {}, std::vector<std::string> preliminaries = {}, std::vector<Type *> &&sub_types = {} );
