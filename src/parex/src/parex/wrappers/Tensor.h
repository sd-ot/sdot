...
public:
    ...
    static Tensor     from_function( std::function<void(Src &,SrcSet &)> &&code, const Vector &shape, ListOfTask &&args = {}, const String &type = "parex::FP64", Memory *memory = default_CpuAllocator.memory() );
    static Tensor     from_function( const std::string &code, const Vector &shape, ListOfTask &&args = {}, const String &type = "parex::FP64", Memory *memory = default_CpuAllocator.memory() );
