...
inline TaskRef Task::call_r( const Kernel &kernel, std::vector<TaskRef> &&inputs, bool append_parent_task_for_dynamic_insertion ) {
    Task *res = new Task;
    ...
    if ( append_parent_task_for_dynamic_insertion )
