...
// load_aligned -----------------------------------------------------------------------
SIMD_VEC_IMPL_REG_LOAD_ALIGNED( SSE2, std::uint64_t, 2, _mm_load_si128( (__m128i *)data ) );
SIMD_VEC_IMPL_REG_LOAD_ALIGNED( SSE2, std::int64_t , 2, _mm_load_si128( (__m128i *)data ) );
SIMD_VEC_IMPL_REG_LOAD_ALIGNED( SSE2, double       , 2, _mm_load_pd( data ) );
SIMD_VEC_IMPL_REG_LOAD_ALIGNED( SSE2, std::uint32_t, 4, _mm_load_si128( (__m128i *)data ) );
SIMD_VEC_IMPL_REG_LOAD_ALIGNED( SSE2, std::int32_t , 4, _mm_load_si128( (__m128i *)data ) );
SIMD_VEC_IMPL_REG_LOAD_ALIGNED( SSE2, float        , 4, _mm_load_ps( data ) );

// load ------------------------------------------------------------------------------
SIMD_VEC_IMPL_REG_LOAD( SSE2, std::uint64_t, 2, _mm_loadu_si128( (__m128i *)data ) );
SIMD_VEC_IMPL_REG_LOAD( SSE2, std::int64_t , 2, _mm_loadu_si128( (__m128i *)data ) );
SIMD_VEC_IMPL_REG_LOAD( SSE2, double       , 2, _mm_loadu_pd( data ) );
SIMD_VEC_IMPL_REG_LOAD( SSE2, std::uint32_t, 4, _mm_loadu_si128( (__m128i *)data ) );
SIMD_VEC_IMPL_REG_LOAD( SSE2, std::int32_t , 4, _mm_loadu_si128( (__m128i *)data ) );
SIMD_VEC_IMPL_REG_LOAD( SSE2, float        , 4, _mm_loadu_ps( data ) );

// store_aligned -----------------------------------------------------------------------
SIMD_VEC_IMPL_REG_STORE_ALIGNED( SSE2, std::uint64_t, 2, _mm_store_si128( (__m128i *)data, impl.data.reg ) );
SIMD_VEC_IMPL_REG_STORE_ALIGNED( SSE2, std::int64_t , 2, _mm_store_si128( (__m128i *)data, impl.data.reg ) );
SIMD_VEC_IMPL_REG_STORE_ALIGNED( SSE2, double       , 2, _mm_store_pd   (            data, impl.data.reg ) );
SIMD_VEC_IMPL_REG_STORE_ALIGNED( SSE2, std::uint32_t, 4, _mm_store_si128( (__m128i *)data, impl.data.reg ) );
SIMD_VEC_IMPL_REG_STORE_ALIGNED( SSE2, std::int32_t , 4, _mm_store_si128( (__m128i *)data, impl.data.reg ) );
SIMD_VEC_IMPL_REG_STORE_ALIGNED( SSE2, float        , 4, _mm_store_ps   (            data, impl.data.reg ) );

// store -------------------------------------------------------------------------------
SIMD_VEC_IMPL_REG_STORE( SSE2, std::uint64_t, 2, _mm_storeu_si128( (__m128i *)data, impl.data.reg ) );
SIMD_VEC_IMPL_REG_STORE( SSE2, std::int64_t , 2, _mm_storeu_si128( (__m128i *)data, impl.data.reg ) );
SIMD_VEC_IMPL_REG_STORE( SSE2, double       , 2, _mm_storeu_pd   (            data, impl.data.reg ) );
SIMD_VEC_IMPL_REG_STORE( SSE2, std::uint32_t, 4, _mm_storeu_si128( (__m128i *)data, impl.data.reg ) );
SIMD_VEC_IMPL_REG_STORE( SSE2, std::int32_t , 4, _mm_storeu_si128( (__m128i *)data, impl.data.reg ) );
SIMD_VEC_IMPL_REG_STORE( SSE2, float        , 4, _mm_storeu_ps   (            data, impl.data.reg ) );
