...
DECL_SIMD_SIZE( std::uint64_t, Arch::AVX512,  8 );
DECL_SIMD_SIZE( std::int64_t , Arch::AVX512,  8 );
DECL_SIMD_SIZE( double       , Arch::AVX512,  8 );
DECL_SIMD_SIZE( std::uint32_t, Arch::AVX512, 16 );
DECL_SIMD_SIZE( std::int32_t , Arch::AVX512, 16 );
DECL_SIMD_SIZE( float        , Arch::AVX512, 16 );
