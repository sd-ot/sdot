...
void S4::cut_ops( KernelSlot *ks, std::map<const ShapeType *,ShapeData> &new_shape_map, const ShapeData &old_shape_data, const void *cut_ids, BI /*dim*/ ) const {
    ...
    ks->mk_items_n4_0_1_1_1_1_1_2_2_f4_0_1_c_i_n4_2_2_3_3_3_0_0_1_f4_2_3_c_i( nsd_S4, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, nsd_S4, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, old_shape_data, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, old_shape_data.cut_case_offsets[ 5 ][ 1 ], old_shape_data.cut_case_offsets[ 5 ][ 2 ], cut_ids, N<2>() );
    ks->mk_items_n4_2_3_3_3_3_3_0_0_f4_2_3_c_i_n4_0_0_1_1_1_2_2_3_f4_0_1_c_i( nsd_S4, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, nsd_S4, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, old_shape_data, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, old_shape_data.cut_case_offsets[ 5 ][ 2 ], old_shape_data.cut_case_offsets[ 5 ][ 3 ], cut_ids, N<2>() );
    ...
    ks->mk_items_n4_3_0_0_0_0_0_1_1_f4_3_0_c_i_n4_1_1_2_2_2_3_3_0_f4_1_2_c_i( nsd_S4, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, nsd_S4, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, old_shape_data, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, old_shape_data.cut_case_offsets[ 10 ][ 0 ], old_shape_data.cut_case_offsets[ 10 ][ 1 ], cut_ids, N<2>() );
    ...
    ks->mk_items_n4_1_2_2_2_2_2_3_3_f4_1_2_c_i_n4_3_3_0_0_0_1_1_2_f4_3_0_c_i( nsd_S4, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, nsd_S4, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, old_shape_data, { 0, 1, 2, 3 }, { 0, 1, 2, 3 }, old_shape_data.cut_case_offsets[ 10 ][ 3 ], old_shape_data.cut_case_offsets[ 10 ][ 4 ], cut_ids, N<2>() );
