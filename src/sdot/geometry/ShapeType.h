...
public:
    ...
    virtual void        cut_count  ( const std::function<void(ShapeType *,BI)> &fc, const BI **offsets ) = 0;
    virtual unsigned    nb_nodes   () const = 0;
    virtual unsigned    nb_faces   () const = 0;
    virtual void        cut_ops    ( const std::function<void(ShapeType *,BI)> &fc, const BI **offsets ) const = 0;
