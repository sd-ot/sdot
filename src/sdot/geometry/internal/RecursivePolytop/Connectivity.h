...
struct Connectivity {
    ...
    void                           for_each_possibility( const std::function<void( const std::vector<std::vector<Obn>> &proposition )> &f, std::vector<std::vector<Obn>> &proposition, TI n ) const;
    void                           for_each_possibility( const std::function<void( const std::vector<std::vector<Obn>> &proposition )> &f ) const;
