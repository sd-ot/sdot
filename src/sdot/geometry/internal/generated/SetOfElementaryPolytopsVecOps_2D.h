...
struct RecursivePolyhedronCutVecOp_2 {
    ...
    template<class ShapeCoords>
    static void cut_l0_0_0_0_1_1_2_l0_0_0_1_2_2_2( const TI *indices_data, TI indices_size, ShapeCoords &nc_0, std::array<TI,3> dst_0_indices, const ShapeCoords &sc, std::array<TI,3> src_indices ) {
        Pos pos;
        Id id;
        ...
        SimdRange<SimdSize<TF,Arch>::value>::for_each( indices_size, [&]( TI beg_num_ind, auto simd_size ) {
            ...
            VF::store( dst_0_pos_1_0_ptr + 2 * beg_num_ind + 1 * simd_size.value, src_pos_1_2_0 );
            VF::store( dst_0_pos_1_1_ptr + 2 * beg_num_ind + 1 * simd_size.value, src_pos_1_2_1 );
            VF::store( dst_0_pos_2_0_ptr + 2 * beg_num_ind + 1 * simd_size.value, src_pos_2_2_0 );
            VF::store( dst_0_pos_2_1_ptr + 2 * beg_num_ind + 1 * simd_size.value, src_pos_2_2_1 );
    ...
    template<class ShapeCoords>
    static void cut_l0_0_0_1_1_2_2( const TI *indices_data, TI indices_size, ShapeCoords &nc_0, std::array<TI,3> dst_0_indices, const ShapeCoords &sc, std::array<TI,3> src_indices ) {
        Pos pos;
        Id id;
