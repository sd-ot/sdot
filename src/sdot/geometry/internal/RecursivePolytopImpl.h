...
struct RecursivePolytopImpl {
    ...
    void                      plane_cut              ( BumpPointerPool &pool, RecursivePolytopImpl &new_rp, IntrusiveList<Face> &new_faces, std::vector<Vertex *> &new_vertices, TI date, N<1> ) const;
    template<class B> void    plane_cut              ( BumpPointerPool &pool, RecursivePolytopImpl &new_rp, IntrusiveList<Face> &new_faces, std::vector<Vertex *> &new_vertices, TI date, B ) const;
